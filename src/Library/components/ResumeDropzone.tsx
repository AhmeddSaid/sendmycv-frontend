...
import { initialSettings, type ShowForm } from "@/_lib/redux/settingsSlice";
	...
	const onImportClick = async () => {
		...
		if (getHasUsedAppBefore()) {
			...
			const sectionToFormToShow: {
				...
				language: resume.languages.descriptions.length > 0,
		...
		// saveStateToLocalStorage({ resume, settings, textAreaStore: { textAreaValue: "" } });
