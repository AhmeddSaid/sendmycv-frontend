...
import { TextAreaShell } from "@/Library/components/UI/TextArea";
import { useAutosizeTextareaHeight } from "@/_lib/hooks/useAutosizeTextareaHeight";
...
export const Textarea = <T extends string>({
	...
	return (
		<InputGroupWrapper label={label} generateWithAI={generateWithAI}>
			<TextAreaShell
				ref={textareaRef}
				name={name}
				placeholder={placeholder}
...
//         return "<div></div>";
//     }
//     // console.log(bulletListStrings, "sfdfsdffd")
