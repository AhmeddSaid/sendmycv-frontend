...
import styled from "styled-components"; // import { forgotPasswordAction } from "@/_lib/actions";
import * as Yup from "yup";
import { Button } from "../../../components/UI/Button";
import Input from "../../../components/UI/Input";
import { LoginForm, SignUpLink } from "../Auth.styles";
import styles from "./../../../Grids/Spaces.module.css";
import { Flexbox } from "@/Library/Grids/Grids"; // import { forgotPasswordAction } from "@/_lib/actions";
import ErrorIcon from "@/Library/components/Notification/ErrorIcon/ErrorIcon"; // import { forgotPasswordAction } from "@/_lib/actions";
import Notifications from "@/Library/components/Notification/Notification";
import { forgotPasswordAction } from "@/app/[locale]/auth/forgot-password/action"; // import { forgotPasswordAction } from "@/_lib/actions";
						...
						<Shell $justify={"center"} $align={"center"}>
							<div>
								...
								<BigParagraph center color={"secondary"}>
									if this email is registered with us, you will receive an email to reset your
									password.
								</BigParagraph>
							</div>
						</Shell>
