import { BULLET_POINTS } from "@/_lib/parse-resume-from-pdf/extract-resume-from-sections/lib/bullet-points";
import { isBold } from "@/_lib/parse-resume-from-pdf/extract-resume-from-sections/lib/common-features";
import type { Line, Lines, Subsections } from "@/_lib/parse-resume-from-pdf/types";
